      ...
      <div className="atlas-container">
        <Reveal>
          <SectionHeading
            ...
            title={
              <>
                What patients <span className="text-shell-500">ask us, often</span>.
              </>
            }
            ...
            return (
              <li key={id}>
                <button
                  ...
                  className="w-full grid grid-cols-[3rem_1fr_2rem] md:grid-cols-[5rem_1fr_2rem] items-baseline gap-6 py-6 md:py-7 text-left hover:bg-shell-50 transition-colors px-1"
                >
