          ...
          <div className="mt-14 border-y-2 border-ink-900">
            ...
            <ul>
              {site.technology.map((item, i) => (
                <li
                  key={item.title}
                  className="grid grid-cols-1 md:grid-cols-[6rem_1fr_2fr] gap-x-8 gap-y-3 px-6 py-8 border-b border-paper-300 last:border-b-0 hover:bg-rose-100 transition-colors"
                >
